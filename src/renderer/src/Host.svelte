...
<WebRTC bind:connectionState bind:this={webRTCComponent} bind:isStreaming bind:readyState />
...
<StreamInterface bind:isReady bind:webRTCComponent bind:isStreaming />
